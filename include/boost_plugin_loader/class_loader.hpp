 ...
 */
#ifndef BOOST_PLUGIN_LOADER_CLASS_LOADER_HPP
#define BOOST_PLUGIN_LOADER_CLASS_LOADER_HPP
...
bool ClassLoader::isClassAvailable(const std::string& symbol_name, const std::string& library_name,
                                   const std::string& library_directory)
{
  boost::system::error_code ec;
  boost::dll::shared_library lib;
...
std::vector<std::string> ClassLoader::getAvailableSymbols(const std::string& section, const std::string& library_name,
                                                          const std::string& library_directory)
{
  boost::system::error_code ec;
  boost::dll::shared_library lib;
...
std::vector<std::string> ClassLoader::getAvailableSections(const std::string& library_name,
                                                           const std::string& library_directory, bool include_hidden)
{
  boost::system::error_code ec;
  boost::dll::shared_library lib;
  if (library_directory.empty())
  ...
  if (ec)
  {
    throw std::runtime_error("Failed to find or load library '" + library_name + "' in directory " + library_directory);
    return std::vector<std::string>();
  }
...
#endif  // BOOST_PLUGIN_LOADER_CLASS_LOADER_HPP
